---
title: "Covid-19 Response Stringency (1)"
author: "Andriy Koval"
date: "May 7, 2020"
output:
  html_document:
...
read_chunk("./analysis/response-stringency-1/response-stringency-1.R")
# read_chunk("../../../analysis/blogposts/florida-suicide-count/fl-suicide-count.R")
```
# Abstract
Explores the response of OECD countries
...
# Q1 - Trend of Response Magnitute

> What was the trend of the response to COVID-10 by each country?  

```{r q1, echo=TRUE, fig.height=7, fig.width=10, out.width = "1200px", message=FALSE, results='show',warning = F, cache=TRUE}
```

# Q2 

```{r q2, echo=TRUE, fig.height=7, fig.width=10, out.width = "1200px", message=FALSE, results='show',warning = F, cache=TRUE}
```
