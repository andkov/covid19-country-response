...
Source: [OVID-19 Data Repository by the Center for Systems Science and Engineering (CSSE) at Johns Hopkins University](https://github.com/CSSEGISandData/COVID-19)
...
```{r stringency,echo=TRUE,  message=FALSE, results='show',warning = F, cache=TRUE}
```

## Government Response 

```{r government,echo=TRUE,  message=FALSE, results='show',warning = F, cache=TRUE}
```

## Containment Health

```{r containment,echo=TRUE,  message=FALSE, results='show',warning = F, cache=TRUE}
```

## Economic Support

```{r economy,echo=TRUE,  message=FALSE, results='show',warning = F, cache=TRUE}
```
